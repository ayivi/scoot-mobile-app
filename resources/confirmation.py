...
class Confirmation(Resource):
    ...
    def get(cls, confirmation_id: str):
        ...
        return make_response(
            rednder_template("confirmation_page.html", email=confirmation.user.email),
            200,
            headers,
        )
...
class ConfirmationByUser(Resource):
    ...
    def get(cls, user_id: int):
        """
        This endpoint is used for test and biewing Cofirmation models and should not be exposed to public.
        """
    ...
    def post(cls, user_id):
        ...
        try:
            ...
            new_connection = ConfirmationModel(user_id)  # create a neew confirmation
