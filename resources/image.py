...
class ImageUpload(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            # here we only return the basename of the image and the hide the internal folder structure from our user
...
class Image(Resource):
    ...
    def get(self, filename: str):
        ...
        try:
            # try to send the requested file to the user with status code
